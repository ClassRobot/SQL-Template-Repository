...
| 列名                  | 数据类型    | 约束                                          | 说明       |
| --------------------- | ----------- | --------------------------------------------- | ---------- |
| id                    | INT         | NOT NULL, UNIQUE, AUTO_INCREMENT, PRIMARY KEY | 学生会id   |
| student               | BIGINT      | NOT NULL, FOREIGN KEY                         | 学生qq     |
| department            | VARCHAR(50) | NOT NULL                                      | 学生会部门 |
| position              | VARCHAR(50) | NOT NULL                                      | 学生会职位 |
| FOREIGN KEY (student) | BIGINT      | NOT NULL, FOREIGN KEY                         | 学生qq     |

## 反馈表

| 列名      | 数据类型     | 约束                                          | 说明     |
| --------- | ------------ | --------------------------------------------- | -------- |
| id        | INT          | NOT NULL, UNIQUE, AUTO_INCREMENT, PRIMARY KEY | 反馈id   |
| qq        | BIGINT       | NOT NULL                                      | 反馈人qq |
| content   | TEXT         | NOT NULL                                      | 反馈内容 |
| image_md5 | VARCHAR(255) | NULL                                          | 反馈图片 |
| create_at | TIMESTAMP    | NOT NULL, DEFAULT CURRENT_TIMESTAMP           | 反馈时间 |
